<?php
 /* Template Name: Credit Repair Landing */
/**
 * The template for displaying credit repair landing page
 *
...
<div id="primary" class="content-area credit_repair_landing_content">
...
<div class="row credit_repair_landing call_to_action">
    <div class="container align-vertical hero-text" style="padding-top: 70px;">
        <div class="row">
            <div class="col-md-12 col-sm-12 alignncenter" id="hero-txt">
                <div class="col-lg-7 col-lg-offset-3 schedule_text">
                    <div class="row">
                        <div class="col-lg-2 nopadding">
                            <div class="avatara">
                                <img src="/wp-content/uploads/2016/10/d-margeaux-thomas-2.jpg" alt="" draggable="false">
                            </div>
                        </div>
                        <div class="col-lg-9">
                            <div class="row">
...
<script>
x=jQuery('#landing_rating_output').html();
